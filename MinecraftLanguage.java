...
public class MinecraftLanguage extends CustomAssembly{
    ...
    public String getName(){
        return "Minecraft Language";
    }

    @Override
    public String getDescription(){
        return "A language to simulate Minecraft actions using MIPS instructions.";
    }
    ...
    protected void populate(){
      ...
      instructionList.add(
         ...
         new SimulationCode()
         {
            ...
            {
               int[] operands = statement.getOperands();
               int slotReg = operands[0];
               int slot = RegisterFile.getValue(slotReg);
               System.out.println("Switching to hotbar slot " + slot);          
               }
         }));
      instructionList.add(
